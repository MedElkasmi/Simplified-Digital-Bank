    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                ...
                <span class="nav-text">Account Statements</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{route('account.create')}}">Create An Account</a></li>
                </ul>
                <ul aria-expanded="false">
                    <li><a href="{{route('account.index')}}">List Of Accounts</a></li>
                </ul>
            </li>

            <li>
                <a href="{{route('transaction.create')}}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.5 7.49999L10 1.66666L17.5 7.49999V16.6667C17.5 17.1087 17.3244 17.5326 17.0118 17.8452C16.6993 18.1577 16.2754 18.3333 15.8333 18.3333H4.16667C3.72464 18.3333 3.30072 18.1577 2.98816 17.8452C2.67559 17.5326 2.5 17.1087 2.5 16.6667V7.49999Z" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.5 18.3333V10H12.5V18.3333" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="nav-text">Transaction System</span>
                </a>
            </li>

            <li>
                <a href="{{route('interest.create')}}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.5 7.49999L10 1.66666L17.5 7.49999V16.6667C17.5 17.1087 17.3244 17.5326 17.0118 17.8452C16.6993 18.1577 16.2754 18.3333 15.8333 18.3333H4.16667C3.72464 18.3333 3.30072 18.1577 2.98816 17.8452C2.67559 17.5326 2.5 17.1087 2.5 16.6667V7.49999Z" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.5 18.3333V10H12.5V18.3333" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="nav-text">Interest Calculation</span>
                </a>
            </li>

            <li>
                <a href="{{route('currency.create')}}" aria-expanded="false">
                    <div class="menu-icon">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M2.5 7.49999L10 1.66666L17.5 7.49999V16.6667C17.5 17.1087 17.3244 17.5326 17.0118 17.8452C16.6993 18.1577 16.2754 18.3333 15.8333 18.3333H4.16667C3.72464 18.3333 3.30072 18.1577 2.98816 17.8452C2.67559 17.5326 2.5 17.1087 2.5 16.6667V7.49999Z" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7.5 18.3333V10H12.5V18.3333" stroke="#888888" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <span class="nav-text">Multiple Currencies</span>
                </a>
            </li>
            ...
            <li>
                <a href="#" aria-expanded="false">
                    ...
                    <span class="nav-text">Budgeting and Savings</span>
                </a>
            </li>
            ...
            <li>
                <a href="#" aria-expanded="false">
                    ...
                    <span class="nav-text">Two-factor authen</span>
                </a>
            </li>
